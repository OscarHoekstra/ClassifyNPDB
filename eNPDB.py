...
Description: Runs the pipeline for extending the MIBiG and NPDB databases
...
#6 Get classifications for the MIBiG data with ClassyFire.
        print("_____Starting Step 6")
        PrintTime()
    ...
    if 7 not in SkipSteps:
#7 Run ClassyFire on NPDB and put results back into database
        print("_____Starting Step 7")
        PrintTime()
        ...
        Interval,start = interval(start)
        print("_____Step 7 took "+Interval)


#Ending pipeline with print functions
    ScriptEnd = time.time()
